...
def message_log(remetente, destinatario, mensagem):
    ...
    try:
        ...
        sql = "INSERT INTO email_messages (sender, receiver, message, timestamp) VALUES (%s, %s, %s, %s)"
        cursor.execute(sql, (destinatario, remetente, mensagem, timestamp))
